...
<body>
    ...
    <div class="containers">
        ...
        <div class="upload-container">
            <div class="upload-header" style="align-content: center;">📁 Upload File</div>
            <div class="upload-instruction">Select the relevant Excel document to complete your task.</div>
            <div class="dropzone">
                <div class="dropzone-icon">⬆️</div>
                <div class="dropzone-text">Select a file or drag and drop here</div>
                <small>JPG, PNG, or PDF file size no more than 10MB</small><br><br>
                <input type="file" id="fileInput">
                <button class="btn-upload" onclick="document.getElementById('fileInput').click()">Select File</button>
            </div>
        </div> --}}
